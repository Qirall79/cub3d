...
#    Updated: 2024/05/18 11:02:11 by wbelfatm         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CFLAGS = -fsanitize=address -g -Ofast #-Wall -Wextra -Werror 
CC = cc
RM = rm -f

SRCS = main.c hooks.c draw.c raycasting.c utils.c rendering.c sprite.c
OBJS = ${SRCS:.c=.o}
LIBMLX = ./lib/MLX
