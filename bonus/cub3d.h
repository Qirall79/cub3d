...
/*   Updated: 2024/08/09 11:20:01 by wbelfatm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float		get_wall_height(t_config *config,
				float distance, float alpha, int x);
...
int			is_drawable(t_config *config,
				t_vector texture_pos, t_sprite *sprite, int x);
